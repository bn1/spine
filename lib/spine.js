...
(function() {
  ...
  Model = (function(_super) {
    ...
    Model.__filter = function(args, revert) {
      if (revert == null) {
        revert = false;
      }
      return function(rec) {
    ...
    Model.filter = function(args) {
      return this.select(this.__filter(args, false));
    };

    Model.exclude = function(args) {
      return this.select(this.__filter(args, true));
    };

    Model.order_by = function() {
      var key, keys, ref, _i, _len, _ref;
      ...
      if (len(keys) > 1) {
        ...
        return this.all().sort(function(x, y) {
          var result, rev, _ref1;
          key = keys[0];
          result = 1;
          rev = false;
          if (key[0] === '-') {
          ...
          _ref1 = [x[key], y[key]], x = _ref1[0], y = _ref1[1];
    ...
    Model.deleteAll = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        record = _ref[_i];
        _results.push(delete this.records[record.id]);
      }
      return _results;
    };
    ...
    Model.cloneArray = function(array) {
      ...
      $.extend(res, this.model);
      res.recordsValues = function() {
        return this;
      };
